  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Training Centers</h1>
          <p className="text-slate-500">Monitor training centers assigned to your district office.</p>
        </div>
      </div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Registered Learners</TableHead>
                ...
                {loading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={7} className="text-center py-12 text-slate-500">
                      No training centers found for this district.
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
